...
export const eightstorm = defineGame({
  ...
  i18n: {
    en: {
      ...
      "games.eightstorm.suits.S": "Bolt",
      "games.eightstorm.suits.H": "Blaze",
      "games.eightstorm.suits.D": "Gale",
      "games.eightstorm.suits.C": "Tide",
      ...
      "games.eightstorm.ui.submitting": "Submitting...",
      ...
      "games.eightstorm.ui.clockwise": "Clockwise",
      "games.eightstorm.ui.counter_clockwise": "Counter-Clockwise",
      "games.eightstorm.ui.playable_count": "{count} PLAYABLE",
      "games.eightstorm.ui.view_fan": "FAN",
      "games.eightstorm.ui.view_grid": "GRID",
      "games.eightstorm.ui.game_underway": "GAME UNDERWAY!",
      "games.eightstorm.badge.reverse": "REVERSE",
      "games.eightstorm.badge.skip": "SKIP",
      "games.eightstorm.badge.draw2": "+2 DRAW",
      "games.eightstorm.badge.wild8": "WILD 8",
      "games.eightstorm.badge.joker": "JOKER",
    },
  },
  init(ctx) {
