...
export const zaplash = defineGame({
  ...
  i18n: {
    en: {
      "games.zaplash.name": "Zaplash",
      "games.zaplash.description": "Write outrageous answers, vote for the best, zap the rest.",
      "games.zaplash.packs.core": "Zaplash Core (Family Friendly)",
      "games.zaplash.packs.afterdark": "Zaplash After Dark (Mildly Spicy)",
