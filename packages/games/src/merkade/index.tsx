...
export const merkade = defineGame({
  ...
  i18n: {
    en: {
      ...
      "games.merkade.phase.round_intro": "Round Intro",
      ...
      "games.merkade.ui.round_header": "Round {current} of {total}",
      "games.merkade.ui.upcoming_round": "UP NEXT",
      ...
      "games.merkade.ui.round_ready": "Get Ready!",
      "games.merkade.ui.next_round_starting": "Next round starting in a moment...",
      ...
      "games.merkade.ui.rounds_unit": "{count} Rounds",
      "games.merkade.ui.seconds_unit": "{sec}s",
      "games.merkade.ui.round_tooltip": "Round {num}: {format}",
